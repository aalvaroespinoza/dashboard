...
export const GritHabitCard: React.FC<GritHabitCardProps> = ({
  ...
  const isRest = isRestDay(habit, selectedDate) && !isCompleted;
  ...
  return (
    <>
      <Pressable
        ...
        onLongPress={() => setIsOptionsMenuOpen(true)}
        style={({ pressed }) => ({
      ...
      >
        ...
        {/* 1. Header: Racha (Streak) & Puntos / Rest Day */}
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 4 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
            ...
            {isRest && (
              ...
              >
                <Coffee size={11} color={theme.text.tertiary} />
